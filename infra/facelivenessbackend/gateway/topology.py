...
class FaceLivenessGateway(Construct):
    ...
    def bind_start_liveness_session(
        self, functions: FaceLivenessFunctionSet
    ) -> api.ProxyResource:
        """
        ...
        self.__bind_lambda_function(
            ...
            functions.start_liveness_session.function,
            "GET",
        )

    def bind_liveness_session_result(
        self, functions: FaceLivenessFunctionSet
    ) -> api.ProxyResource:
        """
        Configure the service integration
        ...
        self.__bind_lambda_function(
            ...
            functions.liveness_session_result.function,
            "POST",
        )

    def bind_save_face_auth(
        self, functions: FaceLivenessFunctionSet
    ) -> api.ProxyResource:
        """
        Configure the service integration for saving face authenticationZ
        :param integration_http_method: The http method
        """
        self.__bind_lambda_function(
            "savefaceauth", functions.save_face_auth.function, "POST"
        )

    def bind_search_face_by_image(
        self, functions: FaceLivenessFunctionSet
    ) -> api.ProxyResource:
        """
        Configure the service integration for searching face by image
        :param integration_http_method: The http method
        """
        self.__bind_lambda_function(
            "searchfacebyimage", functions.search_face_by_image.function, "POST"
        )

    def __bind_lambda_function(
        self,
        resource_name: str,
        functions: FaceLivenessFunctionSet,
